/*
Link problem: https://app.codility.com/programmers/lessons/4-counting_elements/max_counters/
*/
...
//Solucion de forma no optima
//object MaxCounters {
//  def solution(n: Int, a: Array[Int]): Array[Int] = {
//    var counters:Array[Int] = new Array[Int](n);
//    for( i <- 0 to a.size - 1){
//      if( a(i) > n ){
//        counters = Array.fill[Int](n)(counters.reduceLeft(_ max _))
//      }else{
//        counters( a(i) - 1 ) += 1;
//      }
//    }
